...
- **Диагностика PDF**: Новая функция `diagnose_pdf()` для анализа формата PDF, шифрования и извлечения текста
- **Улучшения обработки PDF**: Лучшая обработка ошибок и логирование в пайплайне загрузки документов
- **Обновления UI Streamlit**: Оптимизированное логирование и интеграция диагностических данных
